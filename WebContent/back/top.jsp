<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@page import="pers.kp.model.ManagerBean"%>
<%
...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <ul class="nav">
    <li><a href="back/default.jsp" target="rightFrame" class="selected"><img src="images/icon01.png" title="工作台" /><h2>工作台</h2></a></li>
    ...
    <li><a href="#">关于</a></li>
    <li><a href="LogoutServlet?task=back" target="_parent">退出</a></li>
    </ul>
    ...
    <div class="user">
	  ...
	  %>
     <span><%=(mb==null?"无用户":mb.getMusername()) %></span> 
     
     
     
  	 <span>${BACK_USER.musername }</span>

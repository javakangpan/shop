...
<body onload="getMcTypeFather()">
	...
	<div class="formbody">
		...
		<form method="post" enctype="multipart/form-data"
			...
			<ul class="forminfo">
				<li><label>商品名称</label><input name="mcname" type="text"
					class="dfinput" /></li>
				<li><label>所属大类</label>
				...
				<input name="price" type="text"
					class="dfinput" /></li>
				<!--  <li><label>添加时间</label><cite><input name="" type="text" value="" class="dfinput"/></cite></li> -->
				<li><label>商品图片</label><cite>
				<input name="pic" type="file"
						value="" /></cite></li>
				<li><label>商品描述</label>
				<textarea name="mcdecx" cols="" rows="" class="textinput"></textarea></li>
				<li><label>商品数量</label>
				<input name="quantity" type="text" value=""
					class="dfinput" /></li>
				<li><label>是否缺货</label><cite> 
				<input name="flag"
						type="radio" value="1" checked="checked" />是&nbsp;&nbsp;&nbsp;&nbsp;
						<input name="flag" type="radio" value="0" checked="checked" />否
				</cite></li>
				<li><input name="" type="submit" class="btn" value="提交" /> <label>&nbsp;</label><input
...
<script>
	...
	function getMctypeSmall(typeid){
		...
		xmlhttp.open("POST","back/McServlet?task=querySun&typeid="+typeid,true);
		xmlhttp.send();

...
<body>
	...
	<!-- <div id="order" class="container"> -->
		<form action="front/filter/OrderServlet?task=add" method="post">
		<table class="table table-hover table-striped  table-bordered">
			<caption >${FRONT_USER.truename }的订单</caption>
			<tr>
			...
			<tr>
				...
				<td>
					<input class="form-control" value="${FRONT_USER.username }" type="text" name="username"/>
				</td>
				<td>记得写
				</td>
			</tr>
			<tr>
				...
				<td>
					<input class="form-control" value="${FRONT_USER.address }" type="text" name="address"/>
				</td>
				<td>记得写
				</td>
			</tr>
			<tr>
				...
				<td>
				<input class="form-control" value="${FRONT_USER.postcade }" type="text" name="postcode"/>
				</td>
				<td>记得写
				</td>
			</tr>
			<tr>
				...
				<td>
				<input class="form-control" value="${FRONT_USER.phoneno }" type="text" name="phoneno"/>
				</td>
				<td>记得写
				</td>
			</tr>
			<tr>
				...
				<td>
				<input class="form-control" value="${FRONT_USER.email }" type="text" name="email"/>
				</td>
				<td>记得写
				</td>
			</tr>
			<tr>
				<td colspan="3" align="center">
					<input class="form-control"  type="submit" value="下订单"/> 
					<input  class="form-control" style="margin-top:10px;" type="reset" value="重置"/>
				</td>
			</tr>
		</table>
		</form>
